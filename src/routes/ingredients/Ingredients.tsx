...
export default function IngredientsPage() {
    ...
    const ingredientsCatalog = useMemo(() => getIngredientsCatalog(recipes), [recipes]);
                    ...
                    <div
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <div
                                ...
                                {recipes.length} recipes in catalog
                            </div>
                        </div>
                    </div>

                    <div className="mb-8 rounded-[1.75rem] border border-white/70 bg-white/90 p-5 shadow-[0_20px_50px_-34px_rgba(15,23,42,0.4)] sm:p-6">
                        <div className="flex flex-col gap-4 border-b border-stone-100 pb-5 sm:flex-row sm:items-end sm:justify-between">
                            ...
                            <div className="rounded-full bg-orange-50 px-4 py-2 text-sm font-semibold text-orange-700 ring-1 ring-orange-100">
                                {ingredientCategories.length} groups
                            </div>
                        </div>
                        ...
                        <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                            {ingredientCategories.map((category) => (
                                <Link
                                    ...
                                    className="group rounded-[1.35rem] border border-stone-100 bg-stone-50/80 px-4 py-4 transition hover:border-orange-200 hover:bg-orange-50"
                                >
                                    <div className="flex items-center justify-between gap-3">
                                        <p className="text-lg font-bold text-stone-900 transition group-hover:text-orange-700">
                                            {category.label}
                                        </p>
